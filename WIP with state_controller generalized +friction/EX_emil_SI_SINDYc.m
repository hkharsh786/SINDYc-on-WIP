clear all, close all 
clc
figpath = './FIGURES/emil_friction/';mkdir(figpath)
datapath = './DATA/emil_friction/'; mkdir(datapath)


SystemModel = 'WIP_friction';
...
polyorder =1;
usesine = 1;
% lambda=40; %works good for gain 500, 1 0.1, fot ct , also 10 20 20 20 gives  better result
lambda_vec = [20,400,20,400]; %can be defined as vec tor as per no of states
eps = 0;  
