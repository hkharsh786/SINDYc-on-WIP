...
if(usesine)
    for k=1:50;
        for state=1:length(yin)
            yout{ind,1} = ['sin(', num2str(k), '*', yin{state}, ')'];
            ind = ind + 1;
            yout{ind,1} = ['cos(', num2str(k), '*', yin{state}, ')'];
            ind = ind + 1;
            yout{ind,1} = ['sin(', num2str(k), '*', yin{state}, ')cos(', num2str(k), '*', yin{state}, ')'];
            ind = ind + 1;
            yout{ind,1} = ['sin(', num2str(k), '*', yin{state}, ')/cos(', num2str(k), '*', yin{state}, ')'];
            ind = ind + 1;
            yout{ind,1} = ['sin(', num2str(k), '*', yin{state}, ')^2'];
            ind = ind + 1;
            yout{ind,1} = ['cos(', num2str(k), '*', yin{state}, ')^2'];
            ind = ind + 1;
        end
    end
end
