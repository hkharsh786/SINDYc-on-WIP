function [dxdt, y, A, B, C, D] = WIP_CT_ode(t, x, u, p)
global Ad Bd Cd Dd;
...
dxdt(2) = ( F - d1*q1d + d2*cos(q2)*q2d/L + m2*L*sin(q2)*q2d*q2d - m2*g*L*cos(q2)*sin(q2) ) / ( (Jr/(2*pi*r)) + m1 + m2*sin(q2)*sin(q2) ) ;
...
dxdt(4) = ( F - d1*q1d + m2*L*sin(q2)*q2d*q2d + (m1+m2+Jr/(2*pi*r))*d2*q2d/(m2*L*cos(q2)) - (m1+m2+Jr/(2*pi*r))*g*sin(q2)/cos(q2) ) / ( m2*L*cos(q2) - (m1 + m2 + Jr/(2*pi*r))*L/cos(q2) );
