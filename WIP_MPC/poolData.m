...
%%%the usesine function in the library has been modified by Kumar Harsh
%%the part is done as a part of my Master thesis: Nonlinear System Identification and
...
if(usesine)
    for k=1:1
        yout = [yout sin(k*yin) cos(k*yin)  sin(k*yin).*cos(k*yin)...
            sin(k*yin)./cos(k*yin)...
            sin(k*yin).*sin(k*yin)...
            cos(k*yin).*cos(k*yin)];
    end
