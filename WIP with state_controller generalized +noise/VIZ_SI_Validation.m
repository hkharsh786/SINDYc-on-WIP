...
ph(4) = plot([t;tA],[x(:,4);xA(:,4)],'Color',ccolors(4,:),'LineWidth',1);
...
xlabel('Time')
ylabel('Input')
title("Applied Input [Training | Validation]");
set(gca,'LineWidth',1, 'FontSize',14)
set(gcf,'Position',[100 100 300 200])
set(gcf,'PaperPositionMode','auto')
